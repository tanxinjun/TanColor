#
#  Be sure to run `pod spec lint TanColor.podspec' to ensure this is a
...
一个改变颜色的库，非常好用，大家都适用我的库吧
  ...
  # Or just: s.author    = "谭新均"
  # s.authors            = { "谭新均" => "1610514151@qq.com" }
  # s.social_media_url   = "http://twitter.com/谭新均"
